...
> **At a Glance:** Embracing dispersion — network architecture and the Iran Moon Program
...
Our proposal is this: if this system — ZKP identity, citizen groups with multi-sig wallets, deliberation, anonymous voting, and a labor marketplace — is effectively adopted by the Iranian community, it has the potential to give rise to an independent, state-free currency.
